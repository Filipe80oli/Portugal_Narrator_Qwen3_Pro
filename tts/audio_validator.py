...
def validate_audio(wav_path: str, text: str) -> AudioQuality:
    ...
    if n_chars <= 10:
        min_floor = 0.15   # "Sim.", "Não.", "- Ok."
    elif n_chars <= 30:
        min_floor = 0.30   # "Está bem.", "Vem cá."
    else:
        min_floor = 0.50   # textos normais

    expected_min = max(min_floor, n_chars / TTS_CHARS_PER_SECOND * TTS_MIN_DURATION_RATIO)
